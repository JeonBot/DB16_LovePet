...
<body>
  <script>
    function checkForm(theForm){
	  if(theForm.input_id.value=="")
      {
	    alert("아이디를 입력하십시오.");
		theForm.input_id.focus();
		return false;
	  }
      else
      {
...
<!--    <td colspan="2" align="center"><a href="del_sugang.php"><img src="image/del_select.png" width="212" height="60" border="0"/></a></td>-->
    ...
    <tr>
      ...
      <tr>
          ...
          <input type="text" name="input_id" id="input_id" size="14" height="20"/>
          <br>
          <input type="password" name="input_pw" id="input_pw" size="15"height="20"/>
          </td>
