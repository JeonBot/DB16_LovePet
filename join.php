    ...
    <table width="500" height="329" border="0" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td width="320" align="left">&nbsp;&nbsp;
          <input name="ACCOUNT" type="text" value="" size="20" /></td>
      </tr>
      <tr>
        <td align="right">닉네임 :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="NICKNAME" type="text" value="" size="20" /></td>
      </tr>
      <tr>
        <td align="right">생년월일(YYYYMMDD) :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="BIRTH" type="text" value="" size="20" /></td>
      </tr>
      <tr>
        <td align="right">아이디 :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="ID" type="text" value="" size="20" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left">&nbsp;&nbsp;
          <input name="NAME" type="text" value="" size="20" /></td>
      </tr>
      <tr>
        <td align="right">이메일(example@hongik.ac.kr) :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="EMAIL" type="text" value="" size="30" /></td>
      </tr>
      <tr>
        <td align="right">주소(**도**읍,면,동) :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="ADDRESS" type="text" value="" size="30" /></td>
      </tr>
      <tr>
        <td align="right">비밀번호 :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="PASSWARD" type="text" value="" size="20" /></td>
      </tr>
      <tr>
        <td align="right">휴대폰번호(010********) :</td>
        <td align="left">&nbsp;&nbsp;
          <input name="PHONE" type="text" value="" size="20" /></td>
      </tr>
      <tr>
