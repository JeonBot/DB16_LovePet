...
include "dbconnect.php";
    $ID = $_SESSION['ID'];
    $query = "SELECT PRICE, SPECIES, SELL_NUM FROM BASKET WHERE MEMBER_NUM = (SELECT MEMBER_NUM FROM MEMBER WHERE ID='$ID')";
    ...
    <tr>
        ...
        <table width="1045" height="103" border="1"  bordercolor="#999999" cellpadding="0" cellspacing="0">
            ...
            <tr bordercolor="#999999">
                <td width="100" align="center"><?php echo $ID; ?> 님이 담은 동물</td>
                <td width="150" align="center">가격</td>
                <td width="150" align="center">버릴 동물</td>
            </tr>
                <?php
                    while($arr = mysqli_fetch_array($result))
                    {
                        ...
                        echo "<td align='center'> <input type='checkbox' name='selection[]' value='$arr[2]'></td>";
                        $total += $arr[0];
                        echo "</tr>";
                    }
        ...
        <table>
            <tr>
                <br>
            <tr>
                <a>동물을 추가하려면 뒤로가기 버튼이나 동물목록/담기 버튼을 누르세요.</a>
                <td align="right"><input type="radio" name="select" value="1"/>모두결제</tr></td>
                <td align="right"><input type="radio" name="select" value="2"/>선택제거</td>
            </tr>
                <br>
                <td colspan="2" align="center"><input name="check_button" type="submit" value="고고고"/></td>
            </tr>
        </table>
        </form>
        </td>
